...
type ComplexityRoot struct {
	Mutation struct {
		Send func(childComplexity int, text string) int
	}
	...
	Subscription struct {
		Submsg func(childComplexity int) int
	}
}
...
type SubscriptionResolver interface {
	Submsg(ctx context.Context) (<-chan string, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.send":
		...
		return e.complexity.Mutation.Send(childComplexity, args["text"].(string)), true
	...
	case "Subscription.submsg":
		if e.complexity.Subscription.Submsg == nil {
			break
		}

		return e.complexity.Subscription.Submsg(childComplexity), true
...
func (ec *executionContext) _Mutation_send(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().Send(rctx, fc.Args["text"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
	}
...
func (ec *executionContext) _Subscription_submsg(ctx context.Context, field graphql.CollectedField) (ret func(ctx context.Context) graphql.Marshaler) {
	fc, err := ec.fieldContext_Subscription_submsg(ctx, field)
	if err != nil {
		return nil
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Subscription().Submsg(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
	}
...
func (ec *executionContext) fieldContext_Subscription_submsg(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Subscription",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) _Subscription(ctx context.Context, sel ast.SelectionSet) func(ctx context.Context) graphql.Marshaler {
	...
	case "submsg":
		return ec._Subscription_submsg(ctx, fields[0])
	default:
